package com.bdiplus.task.constants;
...
public class Constant {
    ...
    public static final String CONFLICT_MESSAGE_TASK_NOT_PRESENT = "Conflict occur while processing your request! "
            + "Maybe task is not present to edit";
    public static final String CONFLICT_MESSAGE_TASK_EXIST = "Conflict occur while processing your request! "
            + "Maybe task is already present";
